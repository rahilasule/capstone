 	...
 	<div class="page-container">
		...
		<!-- Page content -->
	 	<div class="page-content">
			...
			<!-- add product -->
			<form class="form-horizontal form-bordered" method="post" action="../../application/controllers/add_product.php" role="form">
	            <div class="panel panel-default">
	                <div class="panel-body">
				        ...
				        <div class="page-header" style="text-align:right; margin:20px;">
		                    ...
		                    <a href="viewproducts.php"><button type="button" class="btn btn-danger" style="margin-right:10px">Cancel</button></a>
