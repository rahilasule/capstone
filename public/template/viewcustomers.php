		...
		<!-- Page content -->
	 	<div class="page-content">
			...
			<div class="page-header" style="margin:30px">
				<a href="addcustomer.php"><button type="button" class="btn btn-primary">Add Customer</button></a>
			</div>
			<!-- /page header -->
				...
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							...
							<h4 class="modal-title"><i class="icon-paragraph-justify2"></i> Edit Customer</h4>
						</div>

						<!-- Form inside modal -->
						<form method="post" action="../../application/controllers/edit_customer.php" role="form">
